...
func main() {
	...
	*/
	...
	fmt.Println("4th element of an array", x_arr[3])
	fmt.Println(y_arr)
	...
	*/
	...
	// problems
	problem_3()
	smallest_biggest_number()
	simple_big_small_diff()
}
...
func problem_3() {
	...
	fmt.Println("x[2:5] would give you:", x[2:5])
}

func smallest_biggest_number() {
...
func simple_big_small_diff() {

	fmt.Println("\n")
	fmt.Println("A more simple version ... ")
	x := []int{
		48, 96, 86, 68,
		57, 82, 63, 70,
		37, 34, 83, -27,
